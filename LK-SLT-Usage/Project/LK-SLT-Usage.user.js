...
// @match        *://*.internetvas.slt.lk/*
// @run-at       document-start
// @grant        GM_addStyle
// @license      GNU Lesser General Public License v3.0
// @history      10.0.0 Added the mode selection (browser vs userscript)
// @history      09.5.0 Add Remaining vol to Doughnut Charts
// @history      09.0.0 Updated the script
// @history      08.0.0 Updated the script
// @history      07.0.0 Fix minor errors in JS
// @history      06.0.0 Update the warning sign color
// ==/UserScript==
